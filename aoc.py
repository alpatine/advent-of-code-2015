...
def d09data() -> str: return readDataFile('d09_data.txt')
def d10data() -> str: return readDataFile('d10_data.txt')
def d11data() -> str: return readDataFile('d11_data.txt')
def d12data() -> str: return readDataFile('d12_data.txt')
def d13data() -> str: return readDataFile('d13_data.txt')
def d14data() -> str: return readDataFile('d14_data.txt')
def d15data() -> str: return readDataFile('d15_data.txt')
